...
/***/ (function(module, exports, __webpack_require__) {
	...
	var origPass = void 0; // Had to init this global for some reason?
	...
	var onHideSignIn = function onHideSignIn() {
	  $('.sign-in-section').hide();
	  // $('.sign-up-menu').show()
	};
	...
	var onHideSignUp = function onHideSignUp() {
	  $('.sign-up-section').hide();
	...
	var onShowSignUpMenu = function onShowSignUpMenu() {
	  $('.sign-up-menu').show();
	  $('.sign-in-section').hide();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getNewUserFlag = function getNewUserFlag() {
	  return newUserFlag;
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateChore = function onCreateChore(event) {
	  ...
	  var choreEnteredDate = new Date(data.chore.due_on).toJSON().slice(0, 10).replace(/-/g, '/');
	  if (choreEnteredDate < todayDate) {
	    // Can't create a chore before TODAY
	    ...
	    api.createChore(data).then(function (data) {
	...
	var onGetChoresApi = function onGetChoresApi() {
	  api.getChores().then(ui.getChoresSuccess).catch(ui.failure);
	};

	var onGetOneChore = function onGetOneChore(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.getOneChore(data).then(function (data) {
	...
	var onUpdateChore = function onUpdateChore(event) {
	  ...
	  if (choreEnteredDate < todayDate) {
	    ...
	    api.updateChore(data).then(function (data) {
	...
	var onDeleteChore = function onDeleteChore(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.deleteChore(data).then(function (data) {
	    ui.deleteChoreSuccess(data);
	    onGetChoresApi();
	  }).catch(ui.deleteChoreFailure);
	};

	var showChoreOptions = function showChoreOptions() {
	  ...
	  if (!authUi.getNewUserFlag()) {
	    ...
	    var choresApiResult = onGetChoresApi();
	...
	var onShowAddChore = function onShowAddChore() {
	...
	var onHideAddChore = function onHideAddChore() {
	  $('.add-chore-section').hide();
	};

	var onShowUpdateChore = function onShowUpdateChore() {
	...
	var onHideUpdateChore = function onHideUpdateChore() {
	  $('.update-chore-section').hide();
	};

	var onShowDeleteChore = function onShowDeleteChore() {
	...
	var onHideDeleteChore = function onHideDeleteChore() {
	  $('.delete-chore-section').hide();
	};

	var onShowGetOneChore = function onShowGetOneChore() {
	...
	var onHideGetOneChore = function onHideGetOneChore() {
	  $('.get-one-chore-section').hide();
	  $('#one-chore-content').empty();
	};

	var clearAllChores = function clearAllChores() {
	  $('#chore-content').empty();
	};

	var showHomeMenu = function showHomeMenu(data) {
	  $('#chore-content').empty();
	  $('.sign-up-menu').hide();
	  $('.sign-in-menu').hide();
	  $('.sign-out-menu').show();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteChore = function deleteChore(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/chores/' + data.chore.id,
	    method: 'DELETE',
	    data: data,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createChoreFailure = function createChoreFailure(error) {
	...
	var getChoresSuccess = function getChoresSuccess(data) {
	  var showChoresHtml = showChoresTemplate({ chores: data.chores });
	  ...
	  // If a user  has at least 1 task, adjust the menu buttons to show update and edit and delete
	  if (showChoresHtml !== '') {
	    $('.chore-add-menu').show();
	    $('.chore-get-menu').show();
	    $('.chore-get-one-menu').show();
	...
	var getChoresFailure = function getChoresFailure(error) {
	...
	var clearChores = function clearChores() {
	  $('#chore-content').empty();
	};

	var getOneChoreSuccess = function getOneChoreSuccess(data) {
	...
	var getOneChoreFailure = function getOneChoreFailure(error) {
	...
	module.exports = {
	  ...
	  getChoresFailure: getChoresFailure,
	  clearChores: clearChores,
	  ...
	  getOneChoreSuccess: getOneChoreSuccess,
	  getOneChoreFailure: getOneChoreFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class='content'>\n\n     <div class='container'>\n\n        <data-id=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.chore : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n        <small>ID: </small>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.id : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "<br>\n          <small>Task: </small>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.task : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.program(8, data, 0),"data":data})) != null ? stack1 : "")
	    + "<br>\n          <small>Due Date: </small>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.due_on : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.program(12, data, 0),"data":data})) != null ? stack1 : "")
	    + "<br>\n          <small>Number of Days Remaining: </small>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.days_to_due_date : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.program(16, data, 0),"data":data})) != null ? stack1 : "")
	    + "<br>\n          <small>Priority: </small>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.priority_alpha : depth0),{"name":"if","hash":{},"fn":container.program(18, data, 0),"inverse":container.program(20, data, 0),"data":data})) != null ? stack1 : "")
	    + "    </div>\n  </div>\n</div>\n<br>\n<hr>\n";
	    ...
	    return "            "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.task : depth0), depth0))
	    + "\n";
	},"8":function(container,depth0,helpers,partials,data) {
	    return "            No task.\n";
	},"10":function(container,depth0,helpers,partials,data) {
	    return "            "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.due_on : depth0), depth0))
	    + "\n";
	},"12":function(container,depth0,helpers,partials,data) {
	    return "            No Due Date\n";
	},"14":function(container,depth0,helpers,partials,data) {
	    return "            "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.days_to_due_date : depth0), depth0))
	    + "\n";
	},"16":function(container,depth0,helpers,partials,data) {
	    return "            0\n";
	},"18":function(container,depth0,helpers,partials,data) {
	    return "            "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.priority_alpha : depth0), depth0))
	    + "\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.chores : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "216992f2342adb0d22c47ecdae6aad79.jpg";
